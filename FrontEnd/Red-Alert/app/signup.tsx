...
export default function SignupScreen() {
  ...
  const handleSignup = () => {
    if (password === confirmPassword && email && name) {
      // อัปเดตข้อมูล User เข้าส่วนกลางก่อนเปลี่ยนหน้า
      ...
      <KeyboardAvoidingView style={styles.content} behavior={Platform.OS === 'ios' ? 'padding' : undefined}>
        ...
        <View style={styles.formContainer}>
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput style={styles.input} placeholder="Email Address" placeholderTextColor="#888" keyboardType="email-address" autoCapitalize="none" value={email} onChangeText={setEmail} />
          </View>
          <View style={styles.inputContainer}>
...
const styles = StyleSheet.create({
  ...
  inputContainer: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#1e1e1e', borderRadius: 12, marginBottom: 20, paddingHorizontal: 15, borderWidth: 1, borderColor: '#333' },
  icon: { marginRight: 10 },
  input: { flex: 1, paddingVertical: 18, color: '#fff', fontSize: 16 },
  signupButton: { backgroundColor: '#ff4444', paddingVertical: 18, borderRadius: 12, alignItems: 'center', marginTop: 20, shadowColor: '#ff4444', shadowOpacity: 0.3, shadowRadius: 10 },
